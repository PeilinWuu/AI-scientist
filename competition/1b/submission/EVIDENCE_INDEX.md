...
|---|---|---|---|---|
| 白名单执行且禁止任意代码 | `tools/execution_adapter.py`、`code_tools.py` | `test_executor_rejects_*` | execution request/result | readiness、AI Scientist 示例与 benchmark API |
...
| 真实 RMSE 改善 | `competition_runtime.py` | flagship test | `iteration_comparison.json`、fit PNG | benchmark evidence/API |
